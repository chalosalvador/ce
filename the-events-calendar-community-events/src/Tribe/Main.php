...
if ( ! class_exists( 'Tribe__Events__Community__Main' ) ) {
	...
	class Tribe__Events__Community__Main {
		 ...
		 * Use Tribe__Events__Community__Plugin_Register instead
		 *
		 * @deprecated 4.6
		 */
		const REQUIRED_TEC_VERSION = '4.9.3.2';
		...
		public function __construct() {
			...
			add_shortcode( 'tribe_community_events', [ $this, 'doShortCode' ] );
		...
		/**
		 * Outputs the notce about pretty permalinks
		 * @since 1.0.3
		 *
		 * @return string HTML
		 */
		...
		/**
		 * Returns an array of fields required for sumission
		 * @since 3.3
		 *
