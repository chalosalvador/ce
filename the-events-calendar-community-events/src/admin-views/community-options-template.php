...
$base_url                = tribe_get_events_link() . $tce->getOption( 'communityRewriteSlug', 'community', true ) . '/';
...
$rewrite_fields                                        = [
	...
	'current_urls'                          => [
		...
		'html'            => sprintf(
			'<h4>%1$s:</h4>
			<strong>%2$s:</strong> <code>%3$s</code><br>
			<strong>%4$s:</strong> <code>%5$s</code><br>
			<strong>%6$s:</strong> <code>%7$s</code><br>
			<p><strong>%8$s</strong></p>
			<strong>%9$s:</strong> <code>%10$s</code><br>
			<strong>%11$s:</strong> <code>%12$s</code><br>
			<strong>%13$s:</strong> <code>%14$s</code><br>
			<strong>%15$s:</strong> <code>%16$s</code><br>
			...
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['list'] ) ),
			esc_html__( 'Add event', 'tribe-events-community' ),
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['add'] ) ),
			...
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['edit'] ) . '/' . sanitize_title( $tce->rewriteSlugs['event'] ) . '/' ),
			esc_html__( 'Edit venue', 'tribe-events-community' ),
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['edit'] ) . '/' . sanitize_title( $tce->rewriteSlugs['venue'] ) . '/' ),
			esc_html__( 'Edit organizer', 'tribe-events-community' ),
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['edit'] ) . '/' . sanitize_title( $tce->rewriteSlugs['organizer'] ) . '/' ),
			esc_html__( 'Event delete (deprecated)', 'tribe-events-community' ),
			esc_url( $base_url . sanitize_title( $tce->rewriteSlugs['delete'] ) . '/' ),
			$checked,
	...
	'community-rewrite-slug-settings-start' => [
		'html' => '<div id="tribe-events-community-tickets-rewite-slug-settings" class="tribe-dependent" data-depends="#events-community-rewrite-slugs-toggle" data-condition-is-checked>',
	],
];
